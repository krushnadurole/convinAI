...
const { getallbuckets, getProductDetails, updateProduct, deleteProduct, getProductReviews, deleteReview, createProductReview, createbucket, getAdminProducts, getProducts } = require('../controllers/BucketController');
